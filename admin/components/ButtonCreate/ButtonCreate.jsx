...
import { visibleProductCreate, visibleCreateCategory } from '../app/redux/popupSlice';
    ...
    return (
        <div className={style.container}>
            <div className={style.button}>
                {variant == 'category'? 
                <Button width="100%" height='100%' text='Добавить категорию' w={700} f='22px' r='30px' click={() => dispatch(visibleCreateCategory())}/>
                : 
                variant == 'position'? 
